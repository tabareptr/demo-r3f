...
export const P = ({ color, x }) => (
  <>
    ...
    <Box position={[x + 1, 2, -1]} defaultColor={color} />
    <Box position={[x + 2, 2, 0]} defaultColor={color} />
    <Box position={[x + 2, 2, -1]} defaultColor={color} />
    <Box position={[x + 3, 2, 0]} defaultColor={color} />
    <Box position={[x + 3, 2, -1]} defaultColor={color} />
    <Box position={[x + 3, 3, -1]} defaultColor={color} />
    <Box position={[x + 3, 3, -0]} defaultColor={color} />
    <Box position={[x + 3, 4, -1]} defaultColor={color} />
    <Box position={[x + 3, 4, -0]} defaultColor={color} />
    ...
    <Box position={[x, 2, 0]} defaultColor={color} />
    <Box position={[x, 2, -1]} defaultColor={color} />
    <Box position={[x + 1, 2, 0]} defaultColor={color} />
    <Box position={[x + 1, 2, -1]} defaultColor={color} />
    <Box position={[x + 2, 2, 0]} defaultColor={color} />
    <Box position={[x + 2, 2, -1]} defaultColor={color} />
    <Box position={[x + 3, 2, 0]} defaultColor={color} />
