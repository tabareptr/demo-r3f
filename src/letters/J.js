...
export const J = ({ color, x, onBlockDestroyed, canDestroy }) => (
  <>
    ...
    <Box position={[x + 2, 1, 0]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
    <Box position={[x + 2, 1, -1]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
    ...
    <Box position={[x + 2, 3, 0]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
    <Box position={[x + 2, 3, -1]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
    <Box position={[x + 2, 4, 0]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
    <Box position={[x + 2, 4, -1]} defaultColor={color} onBlockDestroyed={onBlockDestroyed} canDestroy={canDestroy} />
